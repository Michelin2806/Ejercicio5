...
<nav>
        <div class="nav-wrapper #0097a7 cyan darken-2">
            <a href="login.php" class="brand-logo center">Carro</a>
        </div>
</nav>
<br>
<body>
...
<div class="container" style="border-radius: 15px;">    
    ...
    <div>
        <div class="row  #0097a7 cyan darken-2">
            <div class="col s3 marginbottom #e0f2f1 teal lighten-5">
                <!-- Grey navigation panel -->
                <label class="center-align"><h4>Auto de su eleccion </h4></label>
                <?php
            ...
            <div class="col s9 marginbottom white-text text-darken-2 #e0f7fa cyan lighten-5">
                ...
                <table class="striped #9fa8da indigo lighten-3">
                    ...
                    <tr>
                        <td class="center-align"><strong>Repuestos</strong></td>
                        <td class="center-align input-field col s12">
                    ...
                    <tr>
                        <td class="center-align"><strong>Diponibilidad</strong></td>
                        <td class="center-align input-field col s12">
          ...
          <div class="container">
            <div class="row">
              <div class="col l6 s12">
                ...
                <p class="grey-text text-lighten-4">Valeria Carvajal N1013</p>
              </div>
